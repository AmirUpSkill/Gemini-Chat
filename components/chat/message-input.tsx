...
import { PromptInput, PromptInputBody, PromptInputTextarea, PromptInputFooter, PromptInputSubmit, PromptInputTools, PromptInputAttachments, PromptInputAttachment, PromptInputActionMenu, PromptInputActionMenuTrigger, PromptInputActionMenuContent, PromptInputActionAddAttachments, type PromptInputMessage } from "@/components/ai-elements/prompt-input";

interface MessageInputProps { onSubmit: (message: PromptInputMessage) => void; isStreaming: boolean; children: React.ReactNode; }
...
export function MessageInput({ onSubmit, isStreaming, children }: MessageInputProps) {
  return (
    <PromptInput onSubmit={onSubmit} className="rounded-lg shadow-sm" multiple>
      <PromptInputAttachments>{(a) => <PromptInputAttachment key={a.id} data={a} />}</PromptInputAttachments>
      <PromptInputBody><PromptInputTextarea placeholder="Ask Gemini something..." disabled={isStreaming} /></PromptInputBody>
      <PromptInputFooter>
        <PromptInputTools>
